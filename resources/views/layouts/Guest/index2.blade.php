  ...
  <body id="home1">
    ...
    <div class="projects" id="pengumuman">
      <div class="container">
        <div class="row mb-4">
          <div class="col">
            <h2 class="border-bottom pb-2 fw-bold" data-aos="fade-right" data-aos-duration="1000" >Pengumuman<br/> Yang Telah Diselesaikan</h2>
          </div>
        </div>
        <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 g-4">
          <div class="col" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
            <img src="assets/img/projects/projects-5.jpg" alt="unsplash.com" class="w-100 mb-3">
            <h4 class="fw-semibold">ISO</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore architecto, veritatis accusantium in nihil eveniet alias. Odit ipsa aperiam culpa, alias reiciendis dolores eaque necessitatibus magni praesentium, nulla, iusto obcaecati.</p>
          </div>
          <div class="col" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
            <img src="assets/img/projects/projects-4.jpg" alt="unsplash.com" class="w-100 mb-3">
            <h4 class="fw-semibold">ISO</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore architecto, veritatis accusantium in nihil eveniet alias. Odit ipsa aperiam culpa, alias reiciendis dolores eaque necessitatibus magni praesentium, nulla, iusto obcaecati.</p>
          </div>
          <div class="col" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
            <img src="assets/img/projects/projects-1.jpg" alt="unsplash.com" class="w-100 mb-3">
            <h4 class="fw-semibold">ISO</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore architecto, veritatis accusantium in nihil eveniet alias. Odit ipsa aperiam culpa, alias reiciendis dolores eaque necessitatibus magni praesentium, nulla, iusto obcaecati.</p>
          </div>
          <div class="col" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
            <img src="assets/img/projects/projects-2.jpg" alt="unsplash.com" class="w-100 mb-3">
            <h4 class="fw-semibold">ISO</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore architecto, veritatis accusantium in nihil eveniet alias. Odit ipsa aperiam culpa, alias reiciendis dolores eaque necessitatibus magni praesentium, nulla, iusto obcaecati.</p>
          </div>
          <div class="col" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
            <img src="assets/img/projects/projects-3.jpg" alt="unsplash.com" class="w-100 mb-3">
            <h4 class="fw-semibold">ISO</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore architecto, veritatis accusantium in nihil eveniet alias. Odit ipsa aperiam culpa, alias reiciendis dolores eaque necessitatibus magni praesentium, nulla, iusto obcaecati.</p>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row align-items-center row-cols-lg-2 row-cols-1">
        <div class="col d-flex d-lg-block d-none">
          <img src="assets/img/services/services-1.jpg" class="me-2" alt="" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
          <img src="assets/img/services/services-2.jpg" class="me-2" alt="" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
        </div>
        <div class="col">
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingTwo">
                <button class="accordion-button collapsed fw-semibold lh-lg" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                  Tetap aman ketika mengangkat barang
                </button>
              </h2>
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div class="accordion-body" style="text-align: justify;">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam consequuntur, ullam quasi veritatis, odit necessitatibus nobis ut sint recusandae excepturi aliquid eaque beatae corporis autem corrupti quas? Ullam inventore voluptatibus eaque delectus dolores id cupiditate consequuntur blanditiis. Hic iure voluptates necessitatibus blanditiis, eaque, facilis officia illum magni quos eos delectus fuga placeat saepe veniam accusamus beatae, deserunt sapiente natus nulla cum expedita ipsum cupiditate. Quam, fuga quos. Unde blanditiis nulla rem voluptate, sequi ea officia sunt laborum, officiis atque voluptatibus praesentium eos vitae numquam perspiciatis facere, natus illo dignissimos iusto error cumque libero laudantium? Vel veritatis sapiente eveniet aliquam facilis?
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="accordion" id="accordionExample">
            <div class="accordion-item">
              <h2 class="accordion-header" id="heading3">
                <button class="accordion-button collapsed fw-semibold lh-lg" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
                  hai ?
                </button>
              </h2>
    ...
    <div class="container">
      <div class="row row-cols-lg-3 row-cols-1 justify-content-center">
        ...
        <div class="col col-lg-2 d-flex flex-column mb-lg-0 mb-4">
          ...
          <a href="#" class="text-white-50 mt-2 text-decoration-none">Tips</a>
          <a href="#" class="text-white-50 mt-2 text-decoration-none">Kotak P3K</a>
