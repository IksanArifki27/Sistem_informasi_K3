  ...
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner ">
      ...
      <div class="carousel-item">
        ...
        <img src="{{asset('img/k32.png')}}" style="width:100%; backround-size:cover;">
        <div class="container">
          <div class="carousel-caption">
            {{-- <h1>BERITA 2.</h1>
          ...
          <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <img src="{{asset('img/angkat2.jfif')}}" style="width:50%">
                <br><br>
        ...
        <div class="modal" id="myModal2">
          <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <!-- Modal body -->
              <div class="modal-body">
                <img src="{{asset('img/danger.jpg')}}" style="width:30%">
                <br><br>
        ...
        <div class="modal" id="myModal1">
          <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <!-- Modal body -->
              <div class="modal-body">
                <img src="{{asset('img/sampah.jpg')}}" style="width:50%">
                <br><br>
    ...
    <section id="p3k">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div>
            <img src="{{asset('img/p3k.png')}}" class="rounded mx-auto d-block gambar" alt="kotak p3k">
            <br><br>
            <!-- start table -->
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-4 mb-3">
            <div class="card" >
              <img src="{{asset('img/kor.jpg')}}" class="card-img-top" alt="gambar1">
              <div class="card-body">
