...
<html lang="en">
  <head>
    <title>Detail Info Pengumuman</title>
  ...
  <body id="home1">
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    <h1 class="text-white fw-bold mb-4 animate__animated animate__fadeInUp animate__delay-1s">Detail Pengumuman</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="projects" id="pengumuman">
        <div class="container">
            <div class="row mb-4 ">
                <div class="col">
                  <h2 class="fw-semibold border-bottom pb-2 " data-aos="fade-right" data-aos-duration="1000" >{{$data->judul}}</h2>
                </div>
            </div>
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 g-4 justify-content-center ">
                <div class="col" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                    <div class="card-body">
                        <img src="{{asset('gambarPengumuman/'.$data->foto)}}" class="rounded mx-auto d-block" alt="gambarpengumuman">
                    </div>
                </div>
            </div><br><br>
            ...
            <div class="row row-cols-lg-1 row-cols-md-2 row-cols-1 g-4 justify-content-center" style="text-align: justify;">
                <div class="col" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                    <p>{{$data->konten}},({{$data->created_at->format('l,d-m-Y')}})</p>  
            </div>
